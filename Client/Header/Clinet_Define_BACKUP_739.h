...
enum PLAYERMOVE { PMV_NORMAL, PMV_DASHATT, PMV_DASH, PMV_SLIDE, PMV_WALL,PMV_DASHJUMP, PMV_FALL,PMV_END };

enum WEAPON { WP_NON, WP_PISTOL, WP_SHOTGUN, WP_MINIGUN, WP_KATANA, WP_SNIPER, WP_END };

enum WEAPON2 { WP_KICK, WP_KNIFE, WP_BOOK, WP_DOPING, WP2_END };
...
<<<<<<< HEAD
enum SOUNDID {SOUND_BGM, SOUND_PLAYER, SOUND_MONSTER, SOUND_OBJECT, SOUND_WEAPON,SOUND_ITEM,SOUND_PMOVE,SOUND_END};
=======
enum SOUNDID {SOUND_BGM, SOUND_PLAYER, SOUND_MONSTER, SOUND_UI, SOUND_END};
>>>>>>> Hanung
