...
enum SOUNDID {SOUND_BGM, SOUND_PLAYER, SOUND_MONSTER, SOUND_BOSSVOICE, SOUND_BOSSIDLE, SOUND_BOSSROCKET, SOUND_BOSSDASH, SOUND_BOSSEXPLOSION, SOUND_BOSSMACHINEGUN,SOUND_END};
