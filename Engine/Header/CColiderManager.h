...
public:
    enum COLLISION_GROUP {COLLISION_PLAYER, COLLISION_MONSTER, COLLISION_BLOCK,
        ...
        COLLISION_DOOR, COLLISION_TILE_ELECTRIC, COLLISION_TILE_VENT, COLLISION_WALL_SLIDE,
        COLLISION_BULLET, COLLISION_WEAPON, COLLISION_MISSILE, COLLISIOIN_ITEM,COLLISION_END};
