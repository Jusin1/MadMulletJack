...
public:
    enum COLLISION_GROUP {COLLISION_PLAYER, COLLISION_MONSTER, COLLISION_BLOCK, COLLISION_DUMMY, COLLISION_VERWALL, COLLISION_HORWALL, COLLISION_CEILING, COLLISION_END};
