...
public:
    enum COLLISION_GROUP { COLLISION_PLAYER, COLLISION_MONSTER, COLLISION_BLOCK, COLLISION_DUMMY, COLLISION_WALL, COLLISION_CEILING, COLLISION_END };
    enum COLLISION_TYPE {COLLISION_RECT, COLLISION_CUBE, COLLISION_SPHERE};
