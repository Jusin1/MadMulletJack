...
namespace Engine
{
	...
	enum SCENE { SCENE_STATIC, SCENE_LOADING, SCENE_LOGO, SCENE_DEV, SCENE_TUTORIAL, SCENE_STAGE_1, SCENE_STAGE_2, SCENE_STAGE_3, SCENE_SNIPE, SCENE_BOSS, SCENE_CAR, SCENE_PREFAB, SCENE_END };
