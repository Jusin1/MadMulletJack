...
class CScene_Snipe : public CScene
{
private:
	explicit CScene_Snipe(LPDIRECT3DDEVICE9 pGraphicDevice);
	virtual ~CScene_Snipe();

	virtual void Free() override;
public:
	static CScene_Snipe *Create(LPDIRECT3DDEVICE9 pGraphicDevice);
