...
class CScene_Rooftop : public CScene
{
private:
	explicit CScene_Rooftop(LPDIRECT3DDEVICE9 pGraphicDevice);
	virtual ~CScene_Rooftop();

	virtual void Free() override;
public:
	static CScene_Rooftop *Create(LPDIRECT3DDEVICE9 pGraphicDevice);
